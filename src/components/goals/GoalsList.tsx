...
export const GoalsList = ({
  ...
  const getTypeLabel = (type: string) => {
    switch (type) {
      case "save":
        return t("goals.saveMoney");
      case "spend_less":
        return t("goals.spendLess");
      case "earn_more":
        return t("goals.earnMore");
      default:
        return type;
    }
  };
    ...
    return (
      <Card className="finance-card p-8 text-center">
        ...
        <h3 className="text-lg font-semibold mb-2">
          {t("goals.noGoals", "No Financial Goals Yet")}
        </h3>
        <p className="text-muted-foreground">
          {t(
            "goals.createFirstGoal",
              ...
              <div className="flex-1">
                ...
                <div className="space-y-2 mb-4">
                  ...
                  <div className="flex justify-between text-xs text-muted-foreground">
                    <span>
                      {t("goals.progressPercent", {
                        percent: progress.toFixed(1),
                        defaultValue: `${progress.toFixed(1)}% completed`,
                      })}
                    </span>
                    <span className="flex items-center gap-1">
                      ...
                      {daysLeft > 0
                        ...
                        : t("goals.daysOverdue", {
                            ...
                            defaultValue: `${Math.abs(daysLeft)} days overdue`,
                          })}
                    </span>
                  </div>
                </div>
                ...
                {!completed && (
                  <Button
                    ...
                    onClick={() => {
                      const amount = prompt(
                        t(
                          "goals.addProgressPrompt",
                          "Add progress amount (BRL):"
                        )
                      );
                  ...
                  >
                    {t("goals.addProgress", "Add Progress")}
                  </Button>
                )}
                <Button
                  size="sm"
